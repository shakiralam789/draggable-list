function initializeDrag({ dragEndCallBack = null, draggingCallBack = null }) {
  let listContainer;
  ...
  function getAllItems() {
    // if (!items?.length) {
    items = [...listContainer.querySelectorAll(".list-item")];
    // }
    return items;
  }
  ...
  function setup() {
    listContainer = document.querySelector(".drag-list");
  ...
  function dragStart(e) {
    if (
      ...
      draggableItem = e.target.closest(".list-item");
    }
